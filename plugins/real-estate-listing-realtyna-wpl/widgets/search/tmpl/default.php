        ...
        <div id="wpl_searchwidget_<?php echo $widget_id; ?>" class="clearfix">
            ...
            <div class="wpl_search_from_box_top">
                ...
                <?php if($this->show_reset_button): ?>
                    <div class="wpl_search_reset" onclick="wpl_do_reset<?php echo $this->widget_id; ?>([], <?php echo ($this->ajax == 2 ? 'true' : 'false'); ?>);" id="wpl_search_reset<?php echo $widget_id; ?>"><?php echo __('Reset', 'wpl'); ?></div>
                <?php endif; ?>
                ...
                <?php if(wpl_global::check_addon('membership') and ($this->kind == 0 or $this->kind == 1)): ?>
                    <div class="wpl_dashboard_links_container">
                        <?php if(wpl_global::check_addon('save_searches') and ($this->show_saved_searches)) : ?>
                            <a class="wpl-addon-save-searches-link" href="<?php echo $this->membership->URL('searches'); ?>"><?php echo __('Saved Searches', 'wpl'); ?>
                        ...
                        <?php if($this->show_favorites): ?>
                            <a class="wpl-widget-favorites-link" href="<?php echo $this->membership->URL('favorites'); ?>"><?php echo __('Favorites', 'wpl'); ?>
