...
<div class="wpl-widget-search-wp wpl-widget-form-wp" id="<?php echo $this->get_field_id('wpl_search_widget_container'); ?>">
    ...
    <div class="wpl-widget-row">
        ...
        <select id="<?php echo $this->get_field_id('style'); ?>" name="<?php echo $this->get_field_name('style'); ?>">
            <option value="wpl-search-default" <?php if(isset($instance['style']) and $instance['style'] == "wpl-search-default") echo 'selected="selected"'; ?>><?php echo __('Default', 'wpl'); ?></option>
            <option value="wpl-search-sidebar" <?php if(isset($instance['style']) and $instance['style'] == "wpl-search-sidebar") echo 'selected="selected"'; ?>><?php echo __('Sidebar', 'wpl'); ?></option>
            <option value="wpl-search-float" <?php if(isset($instance['style']) and $instance['style'] == "wpl-search-float") echo 'selected="selected"'; ?>><?php echo __('Float', 'wpl'); ?></option>
        </select>
    </div>
    <div class="wpl-widget-row">
    ...
    <div class="wpl-widget-row">
        <label for="<?php echo $this->get_field_id('total_results'); ?>"><?php echo __('Show Total Results', 'wpl'); ?></label>
        <select id="<?php echo $this->get_field_id('total_results'); ?>" name="<?php echo $this->get_field_name('total_results'); ?>">
            <option value="0" <?php if(isset($instance['total_results']) and $instance['total_results'] == "0") echo 'selected="selected"'; ?>><?php echo __('Hide', 'wpl'); ?></option>
            <option value="1" <?php if(isset($instance['total_results']) and $instance['total_results'] == "1") echo 'selected="selected"'; ?>><?php echo __('Show (Inside of Search Button)', 'wpl'); ?></option>
            <option value="2" <?php if(isset($instance['total_results']) and $instance['total_results'] == "2") echo 'selected="selected"'; ?>><?php echo __('Show (Next to Search Button)', 'wpl'); ?></option>
        </select>
    </div>
    <?php endif; ?>
	...
	<div class="wpl-widget-row">
        ...
        <label for="<?php echo $this->get_field_id('show_reset_button'); ?>"><?php echo __('Show Reset Button', 'wpl'); ?></label>
    </div>
    ...
    <?php if(wpl_global::check_addon('membership') and ($this->kind == 0 or $this->kind == 1)): ?>
        <?php if(wpl_global::check_addon('save_searches')): ?>
            <div class="wpl-widget-row">
                ...
                <label for="<?php echo $this->get_field_id('show_saved_searches'); ?>"><?php echo __('Show Saved Searches', 'wpl'); ?></label>
            </div>
        <?php endif; ?>
        <div class="wpl-widget-row">
            ...
            <label for="<?php echo $this->get_field_id('show_favorites'); ?>"><?php echo __('Show Favorites', 'wpl'); ?></label>
        </div>
    <?php endif; ?>
