...
<div class="wpl_links_widget_backend_form wpl-widget-form-wp" id="<?php echo $this->get_field_id('wpl_links_widget_container'); ?>">
    ...
    <?php if(wpl_global::check_addon('pro') and wpl_global::check_addon('membership')): ?>
        <div class="wpl-widget-row">
            <label for="<?php echo $this->get_field_id('favorite_link'); ?>"><?php echo __('Favorite Link', 'wpl'); ?></label>
            <select id="<?php echo $this->get_field_id('favorite_link'); ?>" name="<?php echo $this->get_field_name('favorite_link'); ?>">
                <option value="1" <?php if(isset($instance['favorite_link']) and $instance['favorite_link'] == 1) echo 'selected="selected"'; ?>><?php echo __('Show', 'wpl'); ?></option>
                <option value="0" <?php if(isset($instance['favorite_link']) and $instance['favorite_link'] == 0) echo 'selected="selected"'; ?>><?php echo __('Hide', 'wpl'); ?></option>
            </select>
        </div>
    <?php endif; ?>
    ...
    <?php if(wpl_global::check_addon('save_searches') and wpl_global::check_addon('membership')): ?>
        <div class="wpl-widget-row">
            <label for="<?php echo $this->get_field_id('save_search_link'); ?>"><?php echo __('Save Search Link', 'wpl'); ?></label>
            <select id="<?php echo $this->get_field_id('save_search_link'); ?>" name="<?php echo $this->get_field_name('save_search_link'); ?>">
                <option value="1" <?php if(isset($instance['save_search_link']) and $instance['save_search_link'] == 1) echo 'selected="selected"'; ?>><?php echo __('Show', 'wpl'); ?></option>
                <option value="0" <?php if(isset($instance['save_search_link']) and $instance['save_search_link'] == 0) echo 'selected="selected"'; ?>><?php echo __('Hide', 'wpl'); ?></option>
            </select>
        </div>
    <?php endif; ?>
