...
foreach($wpl_properties as $key=>$gallery)
{
    ...
    if(!$hide_caption)
    {
        $large_images .= '<div class="caption header" data-animate="slideAppearRightToLeft" data-delay="500" data-length="300">
                ...
                <a '.$this->itemprop_url.' href="'.$gallery["property_link"].'" class="btn-primary caption sub sub2 more_info" data-animate="slideAppearRightToLeft" data-delay="1000" data-length="500">'. __('More info', 'wpl').'</a>
             </div>';
    }
