...
<div class="wpl_carousel_widget_backend_form wpl-carousel-widget-<?php echo $this->widget_id; ?>" id="<?php echo $this->get_field_id('wpl_carousel_widget_container'); ?>">
    ...
    <div class="wpl-widget-row">
        ...
        <label><?php echo __('lazy Load', 'wpl'); ?></label>
    </div>
    ...
    <div class="wpl-widget-row">
        <label for="<?php echo $this->get_field_id('data_zip_name'); ?>"><?php echo __('Zip-Code', 'wpl'); ?></label>
    ...
    <div class="wpl-widget-row">
        <label for="<?php echo $this->get_field_id('data_build_year'); ?>"><?php echo __('Year Built Range', 'wpl'); ?></label>
    ...
    <div class="wpl-widget-row">
        <label for="<?php echo $this->get_field_id('data_living_area'); ?>"><?php echo __('SqFt Range', 'wpl'); ?></label>
    ...
    <div class="wpl-widget-row">
        <label for="<?php echo $this->get_field_id('data_price'); ?>"><?php echo __('Price Range', 'wpl'); ?></label>
    ...
    <div id="<?php echo $this->get_field_id('data_sml_fields_container'); ?>" style="<?php echo ((!isset($instance['data']['sml_only_similars']) or (isset($instance['data']['sml_only_similars']) and !$instance['data']['sml_only_similars'])) ? 'display: none;' : ''); ?>">
        ...
        <div class="wpl-widget-row">
                ...
                <label for="<?php echo $this->get_field_id('sml_override_listing'); ?>"><?php echo __('Override Listing Type', 'wpl'); ?></label>
        </div>
        <div id="<?php echo $this->get_field_id('data_sml_override_listing_container'); ?>" style="<?php echo ((!isset($instance['data']['sml_override_listing']) or (isset($instance['data']['sml_override_listing']) and !$instance['data']['sml_override_listing'])) ? 'display: none;' : ''); ?>">
            <div class="wpl-widget-row">
                <label><?php echo __('Show', 'wpl'); ?></label>
                    <select id="<?php echo $this->get_field_id('sml_override_listing_new'); ?>" name="<?php echo $this->get_field_name('data'); ?>[sml_override_listing_new]">
                        <?php foreach($listings as $listing): ?>
                        <option <?php if(isset($instance['data']['sml_override_listing_new']) and $instance['data']['sml_override_listing_new'] == $listing['id']) echo 'selected="selected"'; ?> value="<?php echo $listing['id']; ?>"><?php echo __($listing['name'], 'wpl'); ?></option>
                        <?php endforeach; ?>
                    </select>
            </div>
            <div class="wpl-widget-row">
                    <label><?php echo __('when current listing type is', 'wpl'); ?></label>
                    <select id="<?php echo $this->get_field_id('sml_override_listing_old'); ?>" name="<?php echo $this->get_field_name('data'); ?>[sml_override_listing_old]">
                        <?php foreach($listings as $listing): ?>
                        <option <?php if(isset($instance['data']['sml_override_listing_old']) and $instance['data']['sml_override_listing_old'] == $listing['id']) echo 'selected="selected"'; ?> value="<?php echo $listing['id']; ?>"><?php echo __($listing['name'], 'wpl'); ?></option>
                        <?php endforeach; ?>
                    </select>
                </select>
            </div>
