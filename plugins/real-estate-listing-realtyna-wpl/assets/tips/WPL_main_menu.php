...
$tips[] = array('id'=>6, 'selector'=>'#wpl_dashboard_side_announce h3', 'content'=>$content, 'position'=>array('edge'=>'bottom', 'align'=>'left'), 'buttons'=>array(2=>array('label'=>__('Next Menu', 'wpl'), 'code'=>'window.location.href = "admin.php?page=wpl_admin_data_structure&wpltour=1";'), 3=>array('label'=>__('Previous', 'wpl'))));
