...
$content = '<h3>'.__('Manage Activities', 'wpl').'</h3><p>'.__('You can toggle activities simply by clicking on an action icon.', 'wpl').'</p>';
$tips[] = array('id'=>3, 'selector'=>'#wpl_actions_td_thead', 'content'=>$content, 'position'=>array('edge'=>'right', 'align'=>'center'), 'buttons'=>array(2=>array('label'=>__('Next Menu', 'wpl'), 'code'=>'window.location.href = "admin.php?page=wpl_admin_notifications&wpltour=1";'), 3=>array('label'=>__('Previous', 'wpl'), 'code'=>'wplj("#activity_manager_filter").val("");wplj("#activity_manager_filter").trigger("keyup");')));
