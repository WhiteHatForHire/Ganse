...
$content = '<h3>'.__('WPL Dashboard', 'wpl').'</h3><p>'.__('Welcome to WPL dashboard. Here, you will see information about WPL and its add-ons, WPL manuals, KB articles and some statistics about your website. You can update WPL PRO and its add-ons from this menu too.', 'wpl').'</p>';
...
$articles  = '';
$articles .= '<li><a href="https://support.realtyna.com/index.php?/Knowledgebase/Article/View/557/28/how-to-update-wpl-pro" target="_blank">'.__('How do I update WPL PRO?', 'wpl').'</a></li>';
...
$articles .= '<li><a href="https://support.realtyna.com/index.php?/Default/Knowledgebase/Article/View/703/" target="_blank">'.__('How do I download my purchased products?', 'wpl').'</a></li>';
