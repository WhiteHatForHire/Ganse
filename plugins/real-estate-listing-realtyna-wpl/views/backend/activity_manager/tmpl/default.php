...
<div class="wrap wpl-wp">
    <header>
        ...
        <h2><?php echo __('Activity Manager', 'wpl'); ?></h2>
    </header>
    ...
    <div class="sidebar-wp">
        <div class="activity_manager_top_bar">
        	<div class="wpl_left_section">
            	<input type="text" name="activity_manager_filter" id="activity_manager_filter" placeholder="<?php echo __('Filter', 'wpl'); ?>" autocomplete="off" />
            </div>
            <div class="wpl_right_section">
                ...
                <span class="wpl_create_new action-btn icon-plus" title="<?php echo __('Add Activity', 'wpl'); ?>" onclick="wpl_generate_modify_activity_page(0);"></span>
        ...
        <table class="widefat page" id="wpl_activity_manager_table">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="manage-column"><?php echo __('Title', 'wpl'); ?></th>
                    <th scope="col" class="manage-column"><?php echo __('Activity', 'wpl'); ?></th>
                    <th scope="col" class="manage-column"><?php echo __('Layout', 'wpl'); ?></th>
                    <th scope="col" class="manage-column"><?php echo __('Position', 'wpl'); ?></th>
                    <th></th>
                    <th id="wpl_actions_td_thead" scope="col" class="manage-column wpl_actions_td"><?php echo __('Actions', 'wpl'); ?></th>
                </tr>
            </thead>
            <tfoot>
                <tr>
                    ...
                    <th scope="col" class="manage-column"><?php echo __('Position', 'wpl'); ?></th>
                    <th></th>
                    <th scope="col" class="manage-column wpl_actions_td"><?php echo __('Actions', 'wpl'); ?></th>
                </tr>
            </tfoot>
