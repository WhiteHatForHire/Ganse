...
<div class="wrap wpl-wp user-wp">
    ...
    <?php if(wpl_global::is_multisite()): $fs = new wpl_addon_franchise(); if($fs->is_agents_limit_reached()): ?>
        <div class="wpl_gold_msg"><?php _e("Your website limit for adding new agents reached so you cannot add new agents to your website!", 'wpl'); ?></div>
    <?php endif; endif; ?>
            ...
            <tbody>
                ...
                <tr id="item_row<?php echo $wp_user->ID; ?>">
                    ...
                    <td>
                        ...
                        <div class="wpl-edit-profile"><a href="<?php echo wpl_global::add_qs_var('id', $wp_user->ID, wpl_global::get_wpl_admin_menu('wpl_admin_profile')); ?>"><?php echo __('Edit Profile', 'wpl'); ?></a></div>
                        <?php else: ?>
                    ...
                    <td>
                        ...
                        <select data-without-chosen name="membership_id_<?php echo $wp_user->ID; ?>" id="membership_id_<?php echo $wp_user->ID; ?>" onChange="wpl_change_membership(<?php echo $wp_user->ID; ?>);" autocomplete="off" title="<?php esc_attr_e('Membership', 'wpl') ?>">
                    ...
                    <td>
                        ...
                        <span id="wpl_user_expire<?php echo $wp_user->ID; ?>" class="action-btn icon-disabled" onclick="wpl_expire_user(<?php echo $wp_user->ID; ?>);" title="<?php echo __('Expire User Now', 'wpl'); ?>"></span>
                        <?php endif; ?>
                    </td>
                    <?php endif; ?>
                    <td class="wpl_manager_td">
                        ...
                        <span class="<?php if (!$wp_user->id) echo 'wpl_hidden_element'; ?>  wpl_actions_icon_disable" id="added_to_wpl<?php echo $wp_user->ID; ?>">                	
                            <span class="action-btn icon-recycle" onclick="wpl_remove_user(<?php echo $wp_user->ID; ?>, 0);" title="<?php echo __('Remove user from WPL', 'wpl'); ?>"></span>
                        </span>
