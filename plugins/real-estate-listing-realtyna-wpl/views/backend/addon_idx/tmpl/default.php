...
<div class="wpl-idx-addon wrap wpl-wp settings-wp">
    <div class="wpl-idx-choose-plan">
        <header>
            ...
            <h2><?php echo __('Organic IDX / Plan', 'wpl'); ?></h2>
        </header>
                    ...
                    <div class="wpl-row" style="width: 50%;margin: auto">
                        <div class="wpl-small-12 wpl-medium-6 wpl-large-6 wpl-column">
                            <a class="wpl-idx-plan wpl-idx-plan-trial" href="<?php echo wpl_global::add_qs_var('tpl', 'trial'); ?>"  >
                                <span class="title"><?php echo __('Trial Version', 'wpl');?></span>
                                <span class="description"><?php echo __('In this plan sample properties will be imported to your website. In order to test our software', 'wpl');?></span>

                            </a>
                        </div>
                        <div class="wpl-small-12 wpl-medium-6 wpl-large-6 wpl-column">
                            <a class="wpl-idx-plan wpl-idx-plan-valid" href="<?php echo wpl_global::add_qs_var('tpl', 'valid'); ?>">
                                <span class="title"><?php echo __('Full Version', 'wpl');?></span>
                                <span class="description"><?php echo __('In this plan you will receive actual properties from your requested mls provider', 'wpl');?></span>
                            </a>
                        </div>
                    </div>
                </div>
