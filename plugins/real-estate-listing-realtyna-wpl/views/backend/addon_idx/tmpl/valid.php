...
<div class="wpl-idx-addon wrap wpl-wp settings-wp">
    <div class="wpl-idx-wizard-main wpl-idx-valid">
        <header>
            ...
            <h2><?php echo __('Organic IDX / Registration Wizard', 'wpl'); ?></h2>
        </header>
                        ...
                        <div class="wpl-wizard-sections">
                            <div id="wpl-wizard-section1" class="wpl-wizard-section wpl-idx-sign-up wpl-idx-form current">
                                ...
                                <div class="wpl-idx-wizard-navigation clearfix">
                                    ...
                                    <a class="btn next" onclick="wpl_idx_form_validation('.wpl-idx-sign-up','registration');"><?php echo __('Next', 'wpl');?></a>
                                </div>
                            </div>
                            <div id="wpl-wizard-section2" class="wpl-wizard-section wpl-idx-choose-mls wpl-idx-table clearfix">
                                <div class="wpl-row wpl-idx-table-tools">
                                    ...
                                    <div class="wpl-small-12 wpl-medium-6 wpl-large-6 wpl-large-offset-2 wpl-column wpl-idx-add-mls-request">
                                        <a class="btn" href="#wpl_request_mls_fancybox_cnt" data-realtyna-lightbox data-realtyna-lightbox-opts="reloadPage:false" data-realtyna-href="#wpl_request_mls_fancybox_cnt"><?php echo __('My MLS is not in the list! Request MLS','wpl'); ?></a>
                                        <div id="wpl_request_mls_fancybox_cnt" class="wpl_hidden_element">
                                            <div class="fanc-content size-width-1">
                                                <h2><?php echo __('Request MLS', 'wpl'); ?></h2>
                                                <div class="fanc-body">
                                                    <div class="fanc-row">
                                                        <label for="wpl_location_name"><?php echo __('MLS Provider', 'wpl'); ?></label>
                                                        <input class="text_box" type="text" id="wpl_request_mls_provider" value="" autocomplete="off" />
                                                    </div>
                                                    <div class="fanc-row">
                                                        <label for="wpl_location_abbr"><?php echo __('State', 'wpl'); ?></label>
                                                        <input class="text_box" type="text" id="wpl_request_mls_state" value="" autocomplete="off" />
                                                    </div>
                                                    <div class="fanc-row fanc-button-row">
                                                        <input class="wpl-button button-1" type="submit" id="wpl_submit" value="<?php echo __('Save', 'wpl'); ?>" onclick="wpl_idx_request_mls();" />
                                ...
                                <table id="wpl-idx-all-mls-providers" class="wpl-idx-addon-table page">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="message"><?php echo __('No MLS Provider is Found!', 'wpl');?></div>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                                <div id="wpl-idx-total-price-choose-mls" class="wpl-idx-total-price">
                                    <strong><?php echo __('Total Amount', 'wpl');?>:</strong>
                            ...
                            <div id="wpl-wizard-section4" class="wpl-wizard-section wpl-idx-configuration wpl-idx-form">
                                <div id="wpl-idx-selected-mls-providers-configuration" class="wpl-idx-addon-table">
                                    <div class="message"><?php echo __('No Configuration is Found!', 'wpl');?></div>
                                </div>
                                <div class="wpl-idx-help">
                                    <?php echo __("Need help about this step?",'wpl'); ?>
                                    <a href="https://realtyna.com/contact" target="_blank"><?php echo __("Please create a ticket here",'wpl'); ?></a>
                                </div>
                                <div class="wpl-idx-wizard-navigation clearfix">
                                    <a class="btn next" onclick="wpl_idx_form_validation('.wpl-idx-config-form-part1 .wpl-idx-form','configuration');"><?php echo __('Next', 'wpl');?></a>
