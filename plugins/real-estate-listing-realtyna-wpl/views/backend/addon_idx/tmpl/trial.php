                        ...
                        <div class="wpl-wizard-sections">
                            <div id="wpl-wizard-section1" class="wpl-wizard-section wpl-idx-sign-up wpl-idx-form current">
                                ...
                                <div class="wpl-idx-wizard-navigation clearfix">
                                    ...
                                    <a class="btn next" onclick="wpl_idx_form_validation('.wpl-idx-sign-up','registration');"><?php echo __('Register & import listings', 'wpl');?></a>
                                </div>
                            </div>
                            <div id="wpl-wizard-section2" class="wpl-wizard-section wpl-idx-import-listings clearfix">
                                <div class="wpl-idx-progress-bar">
                                    ...
                                    <div class="percentage">
                                        <div class="title">
                                            <?php echo __('Importing Sample Listings ...','wpl'); ?>
                                        </div>
                                        <div class="subtitle">
                                            <?php echo __('Importing sample listings takes a while. Please do not close this window in order to get all sample listings','wpl'); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
