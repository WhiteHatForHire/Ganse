...
class wpl_listing_controller extends wpl_controller
{
	public function display()
	{
        ...
        // Check Nonce
        if(!wpl_security::verify_nonce(wpl_request::getVar('_wpnonce', ''), 'wpl_listing')) $this->response(array('success'=>0, 'message'=>__('The security nonce is not valid!', 'wpl')));
	...
	public function delete_room()
	{
		...
		$res = (int) $result;
		$message = $res ? __('Deleted.', 'wpl') : __('Error Occured.', 'wpl');
		$data = $item_id;
