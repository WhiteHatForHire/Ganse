...
class wpl_flex_controller extends wpl_controller
{
    ...
    public function get_field_options()
    {
        ...
        {
            $data['operators'] = array(array('name'=>__('Include', 'wpl'), 'key'=>'IN'), array('name'=>__('Exclude', 'wpl'), 'key'=>'NOTIN'));
            $options = array();
            ...
            elseif($field['type'] == 'listings')
            {
                ...
                $listings = array();
                foreach($raw_listings as $raw_listing) $listings[] = array('key'=>$raw_listing['id'], 'name'=>__($raw_listing['name'], 'wpl'));
            ...
            elseif($field['type'] == 'property_types')
            {
                ...
                foreach($raw_property_types as $raw_property_type) $property_types[] = array('key'=>$raw_property_type['id'], 'name'=>__($raw_property_type['name'], 'wpl'));
                
                $data['options'] = $property_types;
            }
        }
        elseif(in_array($field['type'], array('number', 'area', 'price', 'length', 'volume'))) $data['operators'] = array(array('name'=>__('Greater', 'wpl'), 'key'=>'GREATER'), array('name'=>__('Smaller', 'wpl'), 'key'=>'SMALLER'), array('name'=>__('Include', 'wpl'), 'key'=>'IN'), array('name'=>__('Exclude', 'wpl'), 'key'=>'NOTIN'));
        elseif(in_array($field['type'], array('locations'))) $data['operators'] = array(array('name'=>__('Contains', 'wpl'), 'key'=>'LIKE'));
        else $data['operators'] = array(array('name'=>__('Contains', 'wpl'), 'key'=>'LIKE'), array('name'=>__('Include', 'wpl'), 'key'=>'IN'), array('name'=>__('Exclude', 'wpl'), 'key'=>'NOTIN'));
