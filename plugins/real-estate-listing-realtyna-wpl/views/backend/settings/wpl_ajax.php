...
class wpl_settings_controller extends wpl_controller
{
    ...
    private function toggle_cronjobs()
	{
		...
		$message = $res ? __('Operation was successful.', 'wpl') : __('Error Occured.', 'wpl');
		$data = array(
            'label'=>($new_status ? '<strong style="color: red;">'.__('Enabled', 'wpl').'</strong>' : '<strong style="color: green;">'.__('Disabled', 'wpl').'</strong>'),
            'submit_label'=>($new_status ? __('Disable it', 'wpl') : __('Enable it', 'wpl')),
