			...
			<tr id="item_row_<?php echo $unit['id']; ?>">
				...
				<td>
					<select class="selectboxmini" data-wpl-id="<?php echo $unit['id']; ?>" data-wpl-option="after_before" onchange="wpl_change_unit_option(this);">
						...
						<option value="2" <?php if($unit['after_before'] == 2) echo 'selected="selected"'; ?>><?php echo __('Before (with Space)', 'wpl'); ?></option>
						<option value="3" <?php if($unit['after_before'] == 3) echo 'selected="selected"'; ?>><?php echo __('After (with Space)', 'wpl'); ?></option>
					</select>
					<span class="wpl-loader"></span>
				</td>
				<td>
