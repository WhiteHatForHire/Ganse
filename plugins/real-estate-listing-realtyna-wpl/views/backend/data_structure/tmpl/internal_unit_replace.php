		...
		<div class="col-wp">
			<div class="col-fanc-bottom wpl-fanc-full-row">
				<div class="fanc-row fanc-inline-title">
					<?php _e('Replace current unit with another active unit in listings', 'wpl'); ?>
				</div>
				<div class="fanc-row">
					<label for="wpl_replaced_unit"><?php _e('Set new unit type', 'wpl'); ?>:</label>
