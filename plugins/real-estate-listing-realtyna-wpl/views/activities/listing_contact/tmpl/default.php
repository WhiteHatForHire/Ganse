...
<div class="wpl_contact_container wpl-contact-listing-wp" id="wpl_contact_container<?php echo $this->activity_id; ?><?php echo $this->property_id; ?>">
	...
	<form method="post" action="#" id="wpl_contact_form<?php echo $this->activity_id; ?><?php echo $this->property_id; ?>" onsubmit="return wpl_send_contact<?php echo $this->activity_id; ?>(<?php echo $this->property_id; ?>);">
        <div class="form-field">
            <input class="text-box" type="text" id="wpl_contact_fullname<?php echo $this->activity_id; ?><?php echo $this->property_id; ?>" name="fullname" placeholder="<?php echo __('Full Name', 'wpl'); ?>" />
        </div>

        <div class="form-field">
            <input class="text-box" type="text" id="wpl_contact_phone<?php echo $this->activity_id; ?><?php echo $this->property_id; ?>" name="phone" placeholder="<?php echo __('Phone', 'wpl'); ?>" />
        </div>

        <div class="form-field">
            <input class="text-box" type="text" id="wpl_contact_email<?php echo $this->activity_id; ?><?php echo $this->property_id; ?>" name="email" placeholder="<?php echo __('Email', 'wpl'); ?>" />
        </div>

        <div class="form-field wpl-contact-listing-msg">
            <textarea class="text-box" id="wpl_contact_message<?php echo $this->activity_id; ?><?php echo $this->property_id; ?>" name="message" placeholder="<?php echo __('Message', 'wpl'); ?>"></textarea>
        </div>
        ...
        <div class="contact-recaptcha">
            <?php echo wpl_global::include_google_recaptcha('gre_listing_contact_activity'); ?>
            <?php wpl_security::nonce_field('wpl_listing_contact_form'); ?>
        </div>
        <div class="form-field wpl-contact-listing-btn">
            <input class="btn btn-primary" type="submit" value="<?php echo __('Send', 'wpl'); ?>" />
        </div>
    </form>
