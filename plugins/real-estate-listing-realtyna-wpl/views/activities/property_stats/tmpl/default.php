...
<div class="wpl_property_stats_container" id="wpl_property_stats_container<?php echo $property_id; ?>">
    ...
    <div class="wpl_property_stats_inner">
        ...
        <div class="property_stats_contacts">
            <div>
                <span><?php echo __('Contacts', 'wpl') ?></span>: <b><?php echo wpl_property::get_property_stats_item($property_id, 'contact_numb'); ?></b>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="property_stats_contacts">
            <div>
                <span><?php echo __('Including in listings', 'wpl') ?>:</span> <b><?php echo wpl_property::get_property_stats_item($property_id, 'inc_in_listings_numb'); ?></b>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="property_stats_contacts">
            <div>
                <span><?php echo __('Views in Complex Page', 'wpl') ?>:</span> <b><?php echo wpl_property::get_property_stats_item($property_id, 'view_in_parent_numb'); ?></b>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="property_stats_contacts">
            <div>
                <span><?php echo __('Visits', 'wpl') ?></span>: <b><?php echo wpl_property::get_property_stats_item($property_id, 'visit_time'); ?></b>
            </div>
        </div>
        <?php endif; ?>
