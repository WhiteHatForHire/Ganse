		...
		<div class="wpl_agent_info_detail">
			<div class="wpl_agent_info_c wpl-large-8 wpl-medium-8 wpl-small-12 wpl-column clearfix">
				...
				<ul class="wpl-agent-info-main-fields">
					<?php if($website): ?>
						<li class="website"><label><?php echo __('Website', 'wpl') ?>:</label><a <?php echo $this->itemprop_url; ?> href="<?php echo $website; ?>" target="_blank"><?php echo __('View website', 'wpl') ?></a></li>
					<?php endif; ?>

					<?php if(isset($wpl_user['materials']['tel']['value'])): ?>
						<li class="tel" <?php echo $this->itemprop_telephone; ?> ><label><?php echo __('Phone', 'wpl') ?>:</label><a href="tel:<?php echo $wpl_user['materials']['tel']['value']; ?>"><?php echo $wpl_user['materials']['tel']['value']; ?></a></li>
					<?php endif; ?>

					<?php if(isset($wpl_user['materials']['mobile']['value'])): ?>
						<li class="mobile" <?php echo $this->itemprop_telephone; ?> ><label><?php echo __('Mobile', 'wpl') ?>:</label><a href="tel:<?php echo $wpl_user['materials']['mobile']['value']; ?>"><?php echo $wpl_user['materials']['mobile']['value']; ?></a></li>
					<?php endif; ?>
