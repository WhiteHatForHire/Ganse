...
<div class="fanc-row">
    <label for="wpl_o_lazyload"><?php echo __('Lazyload', 'wpl'); ?></label>
    <select class="text_box" name="option[lazyload]" type="text" id="wpl_o_lazyload">
        <option value="0" <?php if(isset($this->options->lazyload) and $this->options->lazyload == '0') echo 'selected="selected"'; ?>><?php echo __('No', 'wpl'); ?></option>
        <option value="1" <?php if(isset($this->options->lazyload) and $this->options->lazyload == '1') echo 'selected="selected"'; ?>><?php echo __('Yes', 'wpl'); ?></option>
    </select>
</div>
