...
$radius_unit = wpl_units::get_default_unit(1);
?>
...
jQuery(document).ready(function()
{
    ...
    <?php if(wpl_global::get_setting('geolocation_listings') and !$geolocation_session): wpl_session::set('geolocation', 1); ?>
        ...
        function wpl_set_geolocation(position)
        {
            ...
            wpl_listing_request_str = wpl_update_qs('sf_radiussearchunit', '<?php echo $radius_unit['id']; ?>', wpl_listing_request_str);
...
function wpl_listing_set_js_triggers()
{
    ...
    wplj(document).on('click', '#map_view', function()
    {
        ...
        //wplj('.wpl_property_listing_container').fadeOut("fast",function()
        //{
            wpl_fix_no_image_size();
