...
<div class="wpl_prp_show_container" id="wpl_prp_show_container">
    <div class="wpl_prp_container" id="wpl_prp_container<?php echo $this->pid; ?>" <?php echo $this->itemscope.' '.$this->itemtype_SingleFamilyResidence; ?>>
        <div class="wpl_prp_show_tabs">
            ...
            <div class="tabs_box">
                <ul class="tabs">
                	<?php if($pshow_gallery_activities): ?>
                    <li><a href="#tabs-1" data-for="tabs-1"><?php echo __('Pictures', 'wpl') ?></a></li>
                    <?php endif; ?>
                    <?php if($pshow_googlemap_activities and $this->location_visibility === true): ?>
                    <li><a href="#tabs-2" data-for="tabs-2" data-init-googlemap="1"><?php echo __('Google Map', 'wpl') ?></a></li>
                    <?php endif; ?>
                    <?php if($pshow_video_activities): ?>
                    <li><a href="#tabs-3" data-for="tabs-3"><?php echo __('Video', 'wpl') ?></a></li>
                    <?php endif; ?>
                    <?php if($pshow_bingmap_activities and $this->location_visibility === true): ?>
                    <li><a href="#tabs-4" data-for="tabs-4" data-init-bingmap="1"><?php echo __("Bird's eye", 'wpl') ?></a></li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
                    ...
                    foreach($values['data'] as $key => $value)
					{
                        ...
                        elseif($value['type'] == 'locations' and isset($value['locations']) and is_array($value['locations']))
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    echo '<div id="wpl-dbst-show'.$value['field_id'].'" class="wpl-column rows location '.$value['keywords'][$ii].'">'.__($value['keywords'][$ii], 'wpl').' : ';
                        ...
                        else echo '<div id="wpl-dbst-show'.$value['field_id'].'" class="wpl-column rows other">' .__($value['name'], 'wpl'). ' : <span>'. __((isset($value['value']) ? $value['value'] : ''), 'wpl') .'</span></div>';
                    }
                    ...
                    <div class="wpl_prp_right_boxes_content">
                        <div class="wpl_prp_right_boxe_details_top clearfix">
                            <div class="wpl_prp_right_boxe_details_left">
                                <ul>
                                    <?php if(trim($listing_id) != ''): ?><li><?php echo __($this->wpl_properties['current']['materials']['mls_id']['name'], 'wpl').' : <span class="value">'.$listing_id.'</span>'; ?></li><?php endif; ?>
                                    <?php if(trim($bedroom) != ''): ?><li <?php echo $this->itemprop_numberOfRooms.' '.$this->itemscope.' '.$this->itemtype_QuantitativeValue ?>><span <?php echo $this->itemprop_name; ?> ><?php echo __($this->wpl_properties['current']['materials']['bedrooms']['name'], 'wpl').' : </span> <span '.$this->itemprop_value.' class="value">'.$bedroom.'</span>'; ?></li><?php endif; ?>
                                    <?php if(trim($bathroom) != ''): ?><li <?php echo $this->itemprop_numberOfRooms.' '.$this->itemscope.' '.$this->itemtype_QuantitativeValue ?>><span <?php echo $this->itemprop_name; ?>><?php echo __($this->wpl_properties['current']['materials']['bathrooms']['name'], 'wpl').' : </span> <span '.$this->itemprop_value.' class="value">'.$bathroom.'</span>'; ?></li><?php endif; ?>
                                    <?php if(trim($build_up_area) != ''): ?><li><?php echo __($build_up_area_name, 'wpl').' : <span class="value" '.$this->itemprop_floorSize.' '.$this->itemscope.' '.$this->itemtype_QuantitativeValue.'><span class="value" '.$this->itemprop_value.'>'.$build_up_area.'</span></span>'; ?></li><?php endif; ?>
                                    ...
                                    <li><?php echo __('Visits', 'wpl').' : <span class="value">'.$visits.($days ? ' '.sprintf(__('in %d days', 'wpl'), $days) : '').'</span>'; ?></li>
                                </ul>
                            </div>
    ...
    <div class="wpl-powered-by-realtyna" style="display: none;">
        <a href="https://realtyna.com">
            <img src="<?php echo wpl_global::get_wpl_url().'assets/img/idx/powered-by-realtyna.svg'; ?>" alt="Powered By Realtyna">
        </a>
    </div>
</div>