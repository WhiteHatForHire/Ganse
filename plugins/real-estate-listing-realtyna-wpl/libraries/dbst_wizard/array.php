...
if($type == 'array' and !$done_this)
{
	...
	<div id="wpl_array_field_value_box<?php echo $field->id; ?>" class="wpl-array-field-values">
        <div class="fanc-row">
            <input class="wpl-button button-1" type="button" onclick="wpl_array_add_value_<?php echo $field->id; ?>()" value="<?php echo __('Add new', 'wpl') ?>">
        </div>
	<?php
	$i = 0;
	...
	foreach ($explode_array_value as $value): $i++?>
		<div class="fanc-row" id="wpl_array_value_row_<?php echo $field->id; ?>_<?php echo $i; ?>">
            ...
            <input class="wpl-button button-1" type="button" onclick="wpl_array_remove_value_<?php echo $field->id; ?>(<?php echo $i; ?>);" value="<?php echo __('Remove', 'wpl') ?>">
        </div>
	<?php endforeach; ?>

	</div>

    <input class="wpl-button button-1 wpl-save-btn" type="button" onclick="wpl_array_save_values_<?php echo $field->id; ?>()" value="<?php echo __('Save', 'wpl') ?>">
	...
	function wpl_array_add_value_<?php echo $field->id; ?>()
	{
		...
		html = '<div class="fanc-row" id="wpl_array_value_row_<?php echo $field->id; ?>_'+wpl_array_param_counter_<?php echo $field->id; ?>+'">'+
                ...
                '<input class="wpl-button button-1" type="button" onclick="wpl_array_remove_value_<?php echo $field->id; ?>('+wpl_array_param_counter_<?php echo $field->id; ?>+');" value="<?php echo __('Remove', 'wpl') ?>"></div>';
