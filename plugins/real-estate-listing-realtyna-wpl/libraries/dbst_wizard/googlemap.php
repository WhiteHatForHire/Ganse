...
<div class="google-map-wp">
    ...
    <?php if(wpl_global::check_addon('demographic') and count($demographic_addon_objects)): ?>
        <div class="dmgfc-objects-wp">
            <label for="wpl_dmgfc_objects<?php echo $field->id; ?>"><?php echo __('Apply boundary from Demographic addon', 'wpl'); ?></label>
            ...
            <input type="button" onclick="wpl_dmgfc_apply_shapes()" value="<?php echo __('Apply', 'wpl'); ?>">
