    ...
    <div class="video-embed-wp" id="video-embed-<?php echo $vid_embed_count; ?>">
        ...
        <div class="row">
            <a class="button_help" href="https://support.realtyna.com/index.php?/Default/Knowledgebase/Article/View/792/28/how-to-get-embed-code-from-youtube-website" target="_blank">
                <?php echo __('Need help?', 'wpl') ?>
            </a>
            <label id="embed_label" for="embed_vid_code<?php echo $vid_embed_count; ?>"><?php echo __('Video embed code', 'wpl'); ?></label>
            <textarea name="embed_vid_code<?php echo $vid_embed_count; ?>" rows="5" cols="50" id="embed_vid_code<?php echo $vid_embed_count; ?>" onblur="video_embed_save(<?php echo $vid_embed_count; ?>);" placeholder="<?php echo sprintf(__('Sample: %s', 'wpl'), "<iframe width='560' height='350' src='http://youtube.com' frameborder='0' allowfullscreen></iframe>"); ?>"><?php echo $vid_embed_item->item_extra2; ?></textarea>
        </div>
...
function add_embed_video()
{
	var embedVideo = rta.template.bind({
		...
		item_extra1: '',
		item_extra2: '',
        help_link: "<?php echo __('Need help?', 'wpl') ?>",
        placeholder: "<?php echo sprintf(__('Sample: %s', 'wpl'), "<iframe width='560' height='350' src='http://youtube.com' frameborder='0' allowfullscreen></iframe>"); ?>",
		id: '-1'
