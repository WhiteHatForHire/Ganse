...
class wpl_users
{
	...
	public static function get_role($user_id = NULL, $superadmin_role = true)
	{
        ...
        $role = is_array($user_data->roles) ? reset($user_data->roles) : 'guest';
	...
	public static function generate_location_text($user_data, $user_id = 0, $glue = ',')
	{
        ...
        // Location Abbr Names
        if(isset($user_data['location1_name']) and trim($user_data['location1_name'])) $locations['location1_abbr'] = __(wpl_locations::get_location_abbr_by_name($user_data['location1_name'], 1), 'wpl');
        if(isset($user_data['location2_name']) and trim($user_data['location2_name'])) $locations['location2_abbr'] = __(wpl_locations::get_location_abbr_by_name($user_data['location2_name'], 2), 'wpl');
