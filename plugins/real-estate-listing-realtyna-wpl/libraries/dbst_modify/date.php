...
<div class="fanc-body">
	...
	<div class="col-wp">
		...
		<div class="col-fanc-right" id="wpl_flex_specific_options">
			...
			?>
			<div class="fanc-row fanc-inline-title">
				<?php echo __('Date Range', 'wpl'); ?>
			</div>
			<div class="fanc-row">
				<label for="<?php echo $__prefix; ?>opt_minimum_date"><?php echo __('Min date', 'wpl'); ?></label>
			...
			<div class="fanc-row">
				<label for="<?php echo $__prefix; ?>opt_maximum_date"><?php echo __('Max date', 'wpl'); ?></label>
