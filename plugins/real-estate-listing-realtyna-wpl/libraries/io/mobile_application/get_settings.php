...
class wpl_io_cmd_get_settings extends wpl_io_cmd_base
{
    ...
    private function prepare_array($objects)
    {
        ...
        {
            $array[] = array('value' => $obj['id'], 'text' => __($obj['name'], 'wpl'));
        }
    ...
    private function get_fields($category, $type)
    {
        ...
        foreach ($fields as $field) 
        {
            $array[] = array('column_name' => 'sf_select_'.$field->table_column, 'value' => __($field->name, 'wpl'));
        }
    ...
    private function get_listing_sorts()
    {
        ...
        {
            $array[] = array('id' => $sort['id'], 'language_keyword' => __($sort['name'], 'wpl'), 'column_name' => $sort['field_name']);
        }
