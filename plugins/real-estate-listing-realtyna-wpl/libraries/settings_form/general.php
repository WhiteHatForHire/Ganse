...
<div class="prow wpl_setting_form_container wpl_st_type<?php echo $setting_record->type; ?> wpl_st_<?php echo $setting_record->setting_name; ?>" id="wpl_st_<?php echo $setting_record->id; ?>">
    <div class="advanced-markers-wp">
        ...
        <p><?php echo __("You can enable advanced map markers simply here. You just need to configure the color and icons and then check Google Maps on your website! Don't forget to click save button below.", 'wpl'); ?></p>
        
        <div class="wpl-advanced-markers-status-wp">
            <label for="wpl_am_status"><?php echo __('Status', 'wpl'); ?></label>
            <select name="wpl_advanced_markers[status]" id="wpl_am_status">
                <option value="0" <?php echo (isset($advanced_markers['status']) and $advanced_markers['status'] == '0') ? 'selected="selected"' : ''; ?>><?php echo __('Disabled', 'wpl'); ?></option>
                <option value="1" <?php echo (isset($advanced_markers['status']) and $advanced_markers['status'] == '1') ? 'selected="selected"' : ''; ?>><?php echo __('Enabled', 'wpl'); ?></option>
            </select>
        </div>
