...
class wpl_page_builders_divi
{
    ...
    public function register_modules()
    {
        ...
        _wpl_import('libraries.page_builders.divi.property_listing');
        new wpl_page_builders_divi_property_listing();
        
        // Property Show Shortcode
        _wpl_import('libraries.page_builders.divi.property_show');
        new wpl_page_builders_divi_property_show();
        
        // Profile Listing Shortcode
        _wpl_import('libraries.page_builders.divi.profile_listing');
        new wpl_page_builders_divi_profile_listing();
        
        // Profile Show Shortcode
        _wpl_import('libraries.page_builders.divi.profile_show');
        new wpl_page_builders_divi_profile_show();
        
        // Profile Wizard Shortcode
        _wpl_import('libraries.page_builders.divi.profile_wizard');
        ...
        if(wpl_global::check_addon('pro'))
        {
            ...
            _wpl_import('libraries.page_builders.divi.user_links');
            if(class_exists('wpl_page_builders_divi_user_links')) new wpl_page_builders_divi_user_links();
            
            // WPL Favorites Widget
            _wpl_import('libraries.page_builders.divi.widget_favorites');
            ...
            _wpl_import('libraries.page_builders.divi.widget_unit_switcher');
        ...
        {
            _wpl_import('libraries.page_builders.divi.addon_save_searches');
            if(class_exists('wpl_page_builders_divi_addon_save_searches')) new wpl_page_builders_divi_addon_save_searches();
        }
        
        // WPL Search Widget
        _wpl_import('libraries.page_builders.divi.widget_search');
        new wpl_page_builders_divi_widget_search();
        
        // WPL Carousel Widget
        _wpl_import('libraries.page_builders.divi.widget_carousel');
        ...
        {
            // WPL Summary Widget
            _wpl_import('libraries.page_builders.divi.widget_summary');
...
function wpl_et_builder_load_modules_styles()
{
    ...
    if(et_is_builder_plugin_active())
    {
        //wp_enqueue_style( 'et-builder-modules-style', ET_BUILDER_URI . '/styles/frontend-builder-plugin-style.css', array(), ET_BUILDER_VERSION );
         $style[] = (object) array('param1'=>'wpl-et-builder-modules-style', 'param2'=>'css/frontend-builder-plugin-style.css');
